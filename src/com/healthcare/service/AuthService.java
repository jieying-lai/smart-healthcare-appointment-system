...
/**
 * Service managing Authentication, Registration, and User Profile operations with strict input validation.
 */
public class AuthService {
    ...
    public void registerPatient(String username, String password, String fullName, String email, 
        ...
        Patient patient = new Patient(userId, username.trim(), password.trim(), fullName.trim(), 
                                      email.trim(), phone.trim(), dateOfBirth.trim(), bloodGroup, 
    ...
    public void validateUsername(String username) throws InvalidRecordException {
        ...
        if (!username.trim().matches("^[a-zA-Z0-9_]+$")) {
            throw new InvalidRecordException("Username contains invalid/garbled characters. Use letters, numbers, or underscores only.");
        }
    }
