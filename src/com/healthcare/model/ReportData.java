...
public class ReportData implements Serializable {
	...
	public ReportData(int totalAppointments, int completedAppointments, int cancelledAppointments, int totalPatients,
			int totalDoctors, double totalRevenue, Map<String, Integer> statusBreakdown,
			Map<String, Integer> doctorWorkload) {
