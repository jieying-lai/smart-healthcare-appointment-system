...
/**
 * Represents a Doctor user in the healthcare system.
...
public class Doctor extends User {
    ...
    public Doctor(String userId, String username, String password, String fullName, 
                  String email, String phone, String specialization, String department, 
                  String roomNumber, double consultationFee) {
